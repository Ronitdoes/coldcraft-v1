...
export default function NavBar() {
  ...
  const [currentDate, setCurrentDate] = useState<string>("MAY 23 2024"); // fallback prevents hydration mismatch
      ...
      <div className="flex justify-end items-center gap-4 md:gap-6 nav-item opacity-0 -translate-y-5">
        ...
        >
          ...
          <div className="relative overflow-hidden flex items-center justify-center">
            ...
            <span className="absolute transition-all duration-500 ease-[cubic-bezier(0.76,0,0.24,1)] -translate-x-[150%] translate-y-[150%] group-hover:translate-x-0 group-hover:translate-y-0">
              →
            </span>
          </div>
        </button>
